<?php
#Import de arquivos de variaveis e constantes
require_once('modulos/vars.php');
#Import de arquivos de funçoes para realizar calculos
require_once('modulos/calculos.php');
    ...
    #Nao resgata elementos do html para ter maior uso e nao ficar preso
               ...
               $opcao= strtolower($_POST["rdoOperacao"]);
                ...
                if(empty($valor1) || empty($valor2))
                {
                 ...
                 elseif(!is_numeric($valor1) || !is_numeric($valor2))
                    ...
                    //Funçãopara realizar os calculos da calculadora    
